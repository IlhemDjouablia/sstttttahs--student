...
if (isset($_SESSION['idst']) && isset($_SESSION['fnamest'])) {
    $id = $_SESSION['idst'];
    $sql = "SELECT * FROM ryc where id_student ='$id' ORDER BY id_ryc DESC";  
   ...
   <div class="container" id="top">
    ...
    <aside class="sidebar-wrapper">
            ...
            <ul>
                    ...
                    <li class="active"><a href="recycle.php" class="sidebar-link" data-section="trash">
...
<a href="contact.php">
  ...
  color:#0e0e0e8f; "></i><span style=" color: #8041f5ab;">Recycle Bin</span> </div>
...
<div class="table__body">
   ...
   {  ?>
           <tr class="score-card">
              ...
              <td><br><?=$row['name_comp']?></td>
              <td> 
                 <a href="back/return.php?id=<?=$row['id_ryc']?>" > <button class="rq-btn"><i class="fa-solid fa-retweet fa-bounce"></i></button> </a>
                 <a href="back/del.php?id=<?=$row['id_ryc']?>" > <button class="rq-btn"><i class='bx bxs-trash bx-flip-horizontal bx-tada' ></i></button> </a>
