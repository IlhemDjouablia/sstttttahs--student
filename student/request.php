...
if (isset($_SESSION['idst']) && isset($_SESSION['fnamest'])) {
    $id = $_SESSION['idst'];
    $sql = "SELECT * FROM request INNER JOIN student ON student.id_student = request.id_student WHERE request.id_student ='$id' AND state IS NULL ORDER BY id_req DESC";  
...
<a href="contact.php">
            ...
            <section id="req-section" class="page-section ">
...
<div class="home__title" style="font-size: 1.6rem;  font-weight: 550;
  ...
  color:#0e0e0e8f; "></i><span style=" color: #8041f5ab;">Request </span> </div>
            <div class="table__header">
            
            <a href="addreq.php" > <button class="create-rq"><i class='bx bx-add-to-queue bx-tada'  style="font-size: 1.8rem;"></i>&nbsp; add new request</button> </a>
...
<div class="table__body">
    <table>
        <thead>
            <tr class="score-card themecar ">
                <th width="8px">ID<span class="icon-arrow">&UpArrow;</span></th>
                <th width="8px">Picture<span class="icon-arrow">&UpArrow;</span></th>
   ...
   {  ?>
           <tr class="score-card">
              ...
              <td> 
                 <a href="view.php?id=<?=$row['id_req']?>" > <button class="rq-btn"><i class="fa-sharp fa-solid fa-eye fa-bounce"></i></button> </a>
                 <a href="edit.php?id=<?=$row['id_req']?>" > <button class="rq-btn"> <i class="fa-regular fa-pen-to-square fa-bounce"></i></button> </a>
                 <a href="back/delete.php?id=<?=$row['id_req']?>" > <button class="rq-btn"><i class='bx bxs-trash bx-flip-horizontal bx-tada' ></i></button> </a></td>
          </tr>
          <?php
   }
          ?>
