...
if (isset($_SESSION['idst']) && isset($_SESSION['fnamest'])) {
    $id = $_SESSION['idst'];
    $sql = "SELECT * FROM request INNER JOIN student ON student.id_student = request.id_student WHERE request.id_student ='$id' AND state=0 or state=00 ORDER BY id_req DESC";  
...
<div class="home__title" style="font-size: 1.6rem;  font-weight: 550;
  ...
  color:#0e0e0e8f; "></i><span style=" color: #f700005e;">Request Refused</span> </div>
...
<div class="table__body">
    <table>
        <thead>
            <tr class="score-card themecar " style="background-color:#f700005e;" >
   ...
   {  ?>
           <tr class="score-card">
              ...
              <td style="text-decoration: line-through;"><br><?=$row['name_comp']?></td>
              <td style="text-decoration: line-through;"><br><?=$row['intern_name']?></td>
              <td> <br>
              <a href="consulte.php?id=<?=$row['id_req']?>" data-section="profile"> <button class="rq-btn" style="background-color:#f700005e; border: 1px solid #f700005e;"><i class="fa-sharp fa-solid fa-eye fa-bounce"></i></button> </a>
