...
if (isset($_SESSION['idst']) && isset($_SESSION['fnamest'])) {
    $id = $_SESSION['idst'];
    $sql = "SELECT * FROM request WHERE id_student='$id' AND state = 100 GROUP BY intern_name ORDER BY id_req DESC";
...
<a href="contact.php">
  ...
  color:#0e0e0e8f; "></i><span style=" color: #8041f5ab;">Internships </span> </div>
       ...
       <div class="table__body">
           <table>
               <thead>
                   <tr class="score-card themecar ">
                       ...
                       <th>grades<span class="icon-arrow">&UpArrow;</span></th>
                       <!-- <th>certificate<span class="icon-arrow">&UpArrow;</span></th> -->
                   </tr>
               </thead>
               <tbody>
                  <?php
          ...
          {  ?>
                  <tr class="score-card">
                     ...
                     <td> 
                        <a href="attendence.php?id=<?=$row['id_req']?>" data-section="profile"> <button class="rq-btn">attendance</button> </a></td>
                        <td> 
                        <a href="grades.php?id=<?=$row['id_req']?>" data-section="profile"> <button class="rq-btn">grades</button> </a></td>
                        <!-- <td> <br>
                        <a href="certificate.php?id=<?=$row['intern_name']?>" data-section="profile"> <button class="bgt88">certificate</button> </a></td>
                         -->
                 </tr>
                 <?php
          }
